...
namespace JobApplicantWebCam.JobRecruitmentServiceServer {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="JobRecruitmentServiceServer.JobRecruitmentWebServiceSoap")]
    public interface JobRecruitmentWebServiceSoap {
        ...
        JobApplicantWebCam.JobRecruitmentServiceServer.SaveApplicantPictureResponse SaveApplicantPicture(JobApplicantWebCam.JobRecruitmentServiceServer.SaveApplicantPictureRequest request);
    }
    ...
    public partial class SaveApplicantPictureRequest {
        ...
        public JobApplicantWebCam.JobRecruitmentServiceServer.SaveApplicantPictureRequestBody Body;
        
        public SaveApplicantPictureRequest() {
        }
        
        public SaveApplicantPictureRequest(JobApplicantWebCam.JobRecruitmentServiceServer.SaveApplicantPictureRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class SaveApplicantPictureResponse {
        ...
        public JobApplicantWebCam.JobRecruitmentServiceServer.SaveApplicantPictureResponseBody Body;
        
        public SaveApplicantPictureResponse() {
        }
        
        public SaveApplicantPictureResponse(JobApplicantWebCam.JobRecruitmentServiceServer.SaveApplicantPictureResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface JobRecruitmentWebServiceSoapChannel : JobApplicantWebCam.JobRecruitmentServiceServer.JobRecruitmentWebServiceSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class JobRecruitmentWebServiceSoapClient : System.ServiceModel.ClientBase<JobApplicantWebCam.JobRecruitmentServiceServer.JobRecruitmentWebServiceSoap>, JobApplicantWebCam.JobRecruitmentServiceServer.JobRecruitmentWebServiceSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        JobApplicantWebCam.JobRecruitmentServiceServer.SaveApplicantPictureResponse JobApplicantWebCam.JobRecruitmentServiceServer.JobRecruitmentWebServiceSoap.SaveApplicantPicture(JobApplicantWebCam.JobRecruitmentServiceServer.SaveApplicantPictureRequest request) {
        ...
        public string SaveApplicantPicture(byte[] byteArray, string applicantId, string urlSender) {
            JobApplicantWebCam.JobRecruitmentServiceServer.SaveApplicantPictureRequest inValue = new JobApplicantWebCam.JobRecruitmentServiceServer.SaveApplicantPictureRequest();
            inValue.Body = new JobApplicantWebCam.JobRecruitmentServiceServer.SaveApplicantPictureRequestBody();
            inValue.Body.byteArray = byteArray;
            inValue.Body.applicantId = applicantId;
            inValue.Body.urlSender = urlSender;
            JobApplicantWebCam.JobRecruitmentServiceServer.SaveApplicantPictureResponse retVal = ((JobApplicantWebCam.JobRecruitmentServiceServer.JobRecruitmentWebServiceSoap)(this)).SaveApplicantPicture(inValue);
